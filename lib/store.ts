...
export const ZONES = [
  ...
  { id: "ZONE_01 :: ABOUT ME",        label: "ABOUT ME + EDUCATION",      range: [0.08, 0.28] as [number, number] },
  { id: "ZONE_02 :: SKILLS",          label: "SKILLS & TECHNOLOGIES",     range: [0.28, 0.48] as [number, number] },
  { id: "ZONE_03 :: PROJECTS",        label: "PROJECTS & EXPERIENCE",     range: [0.48, 0.63] as [number, number] },
  { id: "ZONE_04 :: REACTIVE",        label: "REACTIVE LAYER",            range: [0.63, 0.82] as [number, number] },
